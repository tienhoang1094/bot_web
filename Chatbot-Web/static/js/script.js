...
function action_trigger() {
    ...
    $.ajax({
        url: `http://10.0.18.87:5005/conversations/${user_id}/execute`,
        type: "POST",
...
function send(message) {
    ...
    $.ajax({
        url: "http://10.0.18.87:5005/webhooks/rest/webhook",
        type: "POST",
        contentType: "application/json",
...
function setBotResponse(response) {
    ...
    setTimeout(function() {
        ...
        if (response.length < 1) {
            ...
            var BotResponse = '<img class="botAvatar" src="./static/img/botava.jpg"/><p class="botMsg">' + fallbackMsg + '</p><div class="clearfix"></div>';
            ...
            for (i = 0; i < response.length; i++) {
                ...
                if (response[i].hasOwnProperty("buttons")) {
                    console.log('ding ding ding',response)
...
function createCardsCarousel(cardsData) {
    ...
    for (j = 0; j < cardsData.length; j++) {
        title = cardsData[j].name;
        ratings = Math.round((cardsData[j].ratings / 5) * 100) + "%";
        data = cardsData[j];
        item = '<div class="carousel_cards in-left">' + '<img class="cardBackgroundImage" src="' + cardsData[j].image + '"><div class="cardFooter">' + '<span class="cardTitle" title="' + title + '">' + title + "</span> " + '<div class="cardDescription">' + '<div class="stars-outer">' + '<div class="stars-inner" style="width:' + ratings + '" ></div>' + "</div>" + "</div>" + "</div>" + "</div>";
...
function showBotTyping() {
    ...
    var botTyping = '<img class="botAvatar" id="botAvatar" src="./static/img/botava.jpg"/><div class="botTyping">' + '<div class="bounce1"></div>' + '<div class="bounce2"></div>' + '<div class="bounce3"></div>' + '</div>'
